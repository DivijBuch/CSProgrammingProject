...
cursor.execute('CREATE TABLE IF NOT EXISTS users (user_id INTEGER PRIMARY KEY, name TEXT, user_password TEXT, date_of_birth NUMBER, favourite_artist TEXT, favourite_genre TEXT)')
